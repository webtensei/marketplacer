...
const HeroSection = () => {
  return (
    <div
      className="bg-background grid grid-cols-1 md:grid-cols-2"
    ...
    >
      ...
      <div className="col-span-1 text-center md:text-start mt-[6%] px-6 sm:pr-0 md:pl-6 md:pt-24 md:max-w-[512px] md:ml-auto">
        <h1
          ...
          className="font-black text-3xl md:text-5xl pb-5"
        >
          Автоматизация процессов бизнеса на маркетплейсах
        </h1>
        <p className="text-gray-600 text-lg font-semibold">
          Систематизируйте и анализируйте работу с несколькими маркетплейсами,
          используя всего один интуитивно понятный интерфейст.
        </p>
      ...
      <figure className="col-span-1 flex items-center justify-center relative">
        ...
        <figcaption className="sr-only">
          Скриншот страницы создания карточки для маркетплейсов, скриншот
          аналитики карточки товара, процесс автоматизации с использованием
          нашего приложения
        </figcaption>
      </figure>
    </div>
